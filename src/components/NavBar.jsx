...
const Header = () => {
    ...
    return (<header className="bg-gray-100 text-black relative">
                ...
                <ul className="flex space-x-4">
                    ...
                    <li>
                        <Link href="/contactenos"
                              className="hover:bg-green-800 hover:text-white transition duration-300 rounded px-2 py-1">Contáctenos</Link>
                    </li>
                </ul>
            </nav>
        ...
        {/* Menú desplegable */}
        <div
            className={`lg:hidden bg-gray-100 absolute w-full top-20 z-30 transition-all duration-300 ease-in-out overflow-hidden ${isMenuOpen ? 'max-h-48' : 'max-h-0'}`}
        >
